        ...
        {filterOpen && (
          <div className="cursor-pointer whitespace-nowrap absolute top-[30px] p-[32px] bg-[#fff] z-[9999] left-[50%] -translate-x-[50%] rounded-[8px] border shadow-md">
            <div className="w-[351px]">
              <h3 class="bebas-Neue uppercase text-[#1A1A1A] text-[20px] py-[24px] font-normal leading-[32px]">
                Filters
              </h3>
              <div class="flex items-center mb-4 ">
                <input
                  type="checkbox"
                  value=""
                  class="w-4 h-4 text-[#D5D7D7] bg-gray-100 border-gray-300 rounded focus:ring-[#D5D7D7] dark:focus:ring-[#D5D7D7] dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                />
                <label
                  for="default-checkbox"
                  class="ms-2 text-[16px] font-normal rubik text-[#4A4A4A] dark:text-gray-300"
                >
                  Filter Option #01
                </label>
              </div>
